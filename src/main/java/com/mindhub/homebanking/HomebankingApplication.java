...
//
//            Loan mortgage = new Loan("Mortgage", 500000, mortgagePayments, 30.0);
//            Loan personal = new Loan("Personal", 100000, personalPayments, 20.0);
//            Loan automotive = new Loan("Automotive", 300000, AutomotivePayments, 30.0);
//
